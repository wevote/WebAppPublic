...
urlpatterns = [
    ...
    re_path(r'^retrieve_possible_google_search_users/(?P<candidate_we_vote_id>[0-9]+)/$',
    ...
    re_path(r'^bulk_possible_google_search_users_do_not_match/(?P<candidate_we_vote_id>[0-9]+)/$',
